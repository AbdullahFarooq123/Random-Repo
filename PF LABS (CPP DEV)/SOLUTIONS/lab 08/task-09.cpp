...

{
	...
	while ( ! ( cin >> coloumns ) || coloumns == 0 )
	
	{
		
		cin_clear("No character or a negative number" , "Please enter coloumns of matrix : ") ;
		...
		
		{
	...
	
			{
				...
				
				{
					...
					cout << "Please enter element in matrix_2 at a[" << k << "][" << l << "]" ;
					cin >> matrix_2[k][l] ;
